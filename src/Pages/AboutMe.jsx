      ...
      <motion.div className="container-aboutMe">
        ...
        >
          ...
          <div className="experience-container">
            ...
            <ul>
              <li>
                Creating Single Page Application, Responsive Design and
                multi-page web applications with route-based navigation systems.
              </li>
              <li>
                I have developed games using <b>mathematical logic</b>,
                collision detection, and object animation. I have also
                implemented custom events and utilized localStorage to store
                relevant data.
              </li>
              <li>
                Experience manipulating the <b>DOM</b> with JavaScript,
                selecting elements and updating their properties.
              </li>
              <li>
                Creation of <b>CSS animations</b>, including complex effects
                like parallax, and use React Motion to make dynamic and engaging
                animations. I have expertise in key animation techniques, such
                as easing and timing, and use them to create visually stunning
                and responsive animations.
              </li>
              <li>
                I have experience building web applications with{" "}
                <b>React, TypeScript</b>, and React Router, as well as managing
                and deploying applications from the terminal.
              </li>
            </ul>
          </div>
        </motion.section>
