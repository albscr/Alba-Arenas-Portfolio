        ...
        >
          ...
          <motion.div className="description-container">
            <motion.p
              ...
              animate={{
                opacity: 1,
                transition: { duration: 1.2, ease: "easeIn", delay: 2 },
              }}
            >
              <p>
                As a frontend developer, I combine my passion for design and
                technology to create beautiful and functional web experiences,
                focusing on user-centered design and creating intuitive
                interfaces. In addition to my work, I have taught art, which has
                helped me develop skills such as empathy and understanding the
                needs of others.
              </p>
              {/* <p>
          ...
          <div className="aptitudes-container">
            <motion.div
             ...
             animate={{
               opacity: 1,
               transition: { duration: 1.2, ease: "easeIn", delay: 3 },
             }}
            >
              <h2>Knowledge</h2>
              {/* html */}
              ...
              >
                <path
                  d="M262.083 134.725C251.459 131.066 242.081 124.487 235.025 115.742C227.248 105.998 217.346 98.1627 206.075 92.8344C194.805 87.5062 182.465 84.8263 170 84.9999C153.232 83.8124 136.632 88.9842 123.505 99.4854C110.379 109.987 101.689 125.047 99.1667 141.667C104.135 133.354 111.611 126.832 120.521 123.039C129.431 119.246 139.315 118.377 148.75 120.558C159.357 124.324 168.719 130.941 175.808 139.683C183.628 149.349 193.549 157.103 204.817 162.357C216.085 167.61 228.403 170.224 240.833 170C257.602 171.187 274.202 166.016 287.328 155.514C300.455 145.013 309.144 129.953 311.667 113.333C306.789 121.745 299.336 128.366 290.408 132.217C281.48 136.069 271.549 136.948 262.083 134.725ZM77.9167 205.275C88.5409 208.934 97.9189 215.513 104.975 224.258C112.752 234.002 122.654 241.837 133.925 247.165C145.195 252.494 157.535 255.174 170 255C186.768 256.187 203.368 251.016 216.495 240.514C229.621 230.013 238.311 214.953 240.833 198.333C235.866 206.646 228.389 213.168 219.479 216.961C210.569 220.754 200.685 221.622 191.25 219.442C180.644 215.676 171.281 209.058 164.192 200.317C156.351 190.675 146.426 182.937 135.163 177.686C123.9 172.435 111.592 169.807 99.1667 170C82.3986 168.812 65.7983 173.984 52.6718 184.485C39.5453 194.987 30.8556 210.047 28.3334 226.667C33.2111 218.255 40.6642 211.634 49.5924 207.782C58.5206 203.931 68.4507 203.051 77.9167 205.275Z"
                  fill="black"
                />
              </svg>
          ...
          <div className="resume-container">
            ...
            >
              ...
              <a
                href="https://drive.google.com/file/d/1aj2RBqRCi0nmSwtS_hKXndJY1b2ljF5p/view?usp=share_link"
                target="_blank"
                rel="noopener noreferrer"
              >
                Resume
          ...
          <div className="experience-container">
            ...
            <ul>
              <li>
                I have experience in creating Single Page Applications,
                Responsive Designs, and multi-page web applications with
                <b>route-based navigation systems</b>. Additionally, I have
                developed games utilizing <b>mathematical logic</b>, collision
                detection, and object animation, while also implementing custom
                events and leveraging localStorage to store relevant data.
              </li>
              <li>
                Furthermore, I possess expertise in manipulating the{" "}
                <b>DOM with JavaScript</b>, efficiently selecting elements and
                updating their properties. I have a strong proficiency in
                creating <b>CSS animations</b>, including complex effects like
                parallax. To achieve dynamic and engaging animations, I make use
                of <b>React Motion</b> and employ key animation techniques such
                as easing and timing. This allows me to create visually stunning
                and responsive animations that enhance the overall{" "}
                <b>user experience</b>.
              </li>
              <li>
                In terms of web application development, I have a proven track
                record of building applications with <b>React andTypeScript</b>.
                I am proficient in managing and deploying applications from the
                terminal, ensuring smooth and efficient project execution.
              </li>
            </ul>
          </div>
        </motion.section>
